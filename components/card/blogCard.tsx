...
export default function BlogCard({ card }: { card: BlogCardData }) {
  ...
  return (
    <a
      className="group shadow-xl hover:bg-gray-100 rounded-xl p-5 transition-all dark:hover:bg-white/[.05]"
    ...
    >
      ...
      <div>
        <span className="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-md text-xs font-medium bg-blue-50 text-gray-700 m-1 ml-0">
          C#
        </span>
        <span className="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-md text-xs font-medium bg-blue-50 text-gray-700 m-1 ml-0">
          Learning
