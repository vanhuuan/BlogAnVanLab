...
export default function HotBlog() {
  ...
  return (
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto dark:bg-gray-700">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {imgExample.map((e, index) => {
          const card: BlogCardData = {
            ...
            name: "Tập 1, C# là gì",
            description:
              "Giới thiệu về C# và viết chương trình đầu tiên với C#",
          };
          return <BlogCard key={index} card={card} />;
        })}
      </div>
