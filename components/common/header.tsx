...
export default function Header(){
    ...
    return <header className="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
    <nav
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className="hidden mx-auto sm:block border rounded-md border-gray-400 dark:border-gray-100 ml-10">
          <label htmlFor="icon" className="sr-only">Tìm kiếm</label>
          <div className="relative">
            ...
            <input type="text" id="icon" name="icon" className="py-2 px-4 pl-11 pr-20 block w-92 md:w-96 bg-transparent border-gray-700 shadow-sm rounded-md text-sm text-gray-300 focus:z-10 focus:border-gray-900 focus:ring-gray-600 placeholder:text-gray-500" placeholder="Tìm kiếm"/>
          </div>
        </div>
