...
export default function Home() {
  const slugImgLoader = () => {
    return `https://images.unsplash.com/photo-1661956602116-aa6865609028?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1064&q=80`
  }
    ...
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {imgExample.map((e, index) => {
          return (
            <a key={index} className="group hover:bg-gray-100 rounded-xl p-5 transition-all dark:hover:bg-white/[.05]"
              href="#">
