...
export const metadata: Metadata = {
  ...
  description: 'AnVanLab là website cung cấp các kiến thức lập trình cơ bản và dễ hiểu được viết bởi Văn Hữu An và những người bạn của anh ấy.',
}
        ...
        <header className="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
          <nav className="mt-6 relative max-w-7xl w-full bg-white border border-gray-200 rounded-[36px] mx-2 py-3 px-4 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto dark:bg-gray-800 dark:border-gray-700" aria-label="Global">
            <div className="flex items-center justify-between">
              <a className="flex-none text-xl font-semibold dark:text-white" href="/" aria-label="Brand">AnVanLab</a>
            ...
            <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
              <div className="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:pl-7">
                ...
                <a className="flex items-center gap-x-2 font-medium text-gray-500 hover:text-gay-800 md:border-l md:border-gray-300 md:my-6 md:pl-6 dark:border-gray-700 dark:text-gray-100 dark:hover:text-gray-500" href="/auth/login">
