            ...
            <div className="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                <div className="p-4 sm:p-7">
                    ...
                    <div className="mt-5">
                        ...
                        <div className="py-3 flex items-center text-xs text-dark uppercase before:flex-[1_1_0%] before:border-t before:border-gray-200 before:mr-6 after:flex-[1_1_0%] after:border-t after:border-gray-200 after:ml-6 dark:text-dark dark:before:border-gray-600 dark:after:border-gray-600">
                            Hoặc
                        </div>
                        <form method="POST">
